...
func (in *ProvisioningSpec) DeepCopyInto(out *ProvisioningSpec) {
	*out = *in
	...
	if in.SwitchManagement != nil {
		in, out := &in.SwitchManagement, &out.SwitchManagement
		*out = new(SwitchManagement)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SwitchManagement) DeepCopyInto(out *SwitchManagement) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SwitchManagement.
func (in *SwitchManagement) DeepCopy() *SwitchManagement {
	if in == nil {
		return nil
	}
	out := new(SwitchManagement)
