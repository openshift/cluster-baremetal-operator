	...
	containers := map[string]corev1.Container{
		"metal3-baremetal-operator": {
			...
			Env: []corev1.EnvVar{
				...
				{Name: "IRONIC_ENDPOINT", Value: "https://metal3-ironic.openshift-machine-api.svc.cluster.local/v1/"},
		...
		},
		{
			...
			expectedContainers: []corev1.Container{
				withEnv(
					...
					envWithValue("IRONIC_ENDPOINT", "https://metal3-ironic.openshift-machine-api.svc.cluster.local/v1/"),
				),
			},
			sshkey: "sshkey",
		},
