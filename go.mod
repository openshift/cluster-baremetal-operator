...
replace github.com/metal3-io/baremetal-operator => github.com/openshift/baremetal-operator v0.0.0-20221021112927-c457e46aec1e
...
replace sigs.k8s.io/controller-tools => sigs.k8s.io/controller-tools v0.6.2
